...
void MX_FREERTOS_Init(void) {
  ...
  osThreadDef(LED, LEDThread, osPriorityIdle, 0, 128);
  LEDHandle = osThreadCreate(osThread(LED), NULL);

  /* definition and creation of Debug */
  osThreadDef(Debug, DebugThread, osPriorityLow, 0, 512);
...
/* USER CODE BEGIN Header_LEDThread */
/**
* @brief Function implementing the LED thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_LEDThread */
void LEDThread(void const * argument)
{
